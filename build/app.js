...
class Pacman {
  ...
  reset() {
    ...
    this.pacmanArrow.style.backgroundImage = `url(static/images/characters/pacman/arrow_${this.direction}.svg)`;
  }
  ...
  setSpriteSheet(direction) {
    this.animationTarget.style.backgroundImage = `url(static/images/characters/pacman/pacman_${direction}.svg)`;
  }
  ...
  prepDeathAnimation() {
    ...
    this.animationTarget.style.backgroundSize = `${bgSize}px`;
    this.animationTarget.style.backgroundImage = 'url(static/images/characters/pacman/pacman_death.svg)';
    this.animationTarget.style.backgroundPosition = '0px 0px';
  ...
  changeDirection(newDirection, startMoving) {
    ...
    this.pacmanArrow.style.backgroundImage = `url(static/images/characters/pacman/arrow_${this.desiredDirection}.svg)`;
